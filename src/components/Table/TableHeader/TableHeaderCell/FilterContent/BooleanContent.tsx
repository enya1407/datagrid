...
const BooleanContent = () => {
  ...
  return (
    <div className={styles.visibilityBoolean}>
      <div>
        <Switch
          checked={visibilityBoolean.showTrue}
          size="small"
          onChange={() => dispatch(changeVisibilityBooleansAction('showTrue'))}
        />{' '}
        true
      </div>
      <div>
        <Switch
          checked={visibilityBoolean.showFalse}
          size="small"
          onChange={() => dispatch(changeVisibilityBooleansAction('showFalse'))}
        />{' '}
        false
      </div>
    </div>
